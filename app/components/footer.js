    ...
    <div className="flex flex-col items-center mt-[12%] relative w-full ">
      <div className="flex items-center justify-between py-[64px] px-[36px] bg-black w-[1440px] h-[177px] rounded-[20px] absolute top-[-20%] text-white">
        ...
        <div className="flex flex-col w-[349px] max-h-[105px] gap-3">
          <div className="flex justify-start items-center p-4 bg-white h-[48px] rounded-[62px] gap-x-2">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="text-black flex items-center justify-center bg-white h-[48px] rounded-[62px] font-extrabold">
      ...
      <div className="w-full flex flex-col items-center justify-center bg-[#F0F0F0] h-[499px] gap-y-4 ">
        <div className="w-[1440px] flex items-center justify-between  my-8">
          <div className="flex flex-col justify-center space-y-[32px]">
            ...
            <span className="inline-flex gap-4 mt-4">
              <svg
                width="28"
                height="28"
                viewBox="0 0 28 28"
          ...
          <div className="flex flex-col justify-start items-start font-inter gap-[24px]">
            <h1 className="text-[18px] font-medium tracking-tight">C O M P A N Y</h1>
          ...
          <div className="flex flex-col justify-start items-start font-inter gap-[24px] ">
            <h1 className="text-[18px] font-medium tracking-tight">H E L P</h1>
            <ul className="space-y-[19px] opacity-60 text-[16px]">
          ...
          <div className="flex flex-col justify-start items-start font-inter gap-[24px]">
            <h1 className="text-[18px] font-medium tracking-tight">F A Q</h1>
            <ul className="space-y-[19px] opacity-60 text-[16px]">
              <li>Account</li>
          ...
          <div className="flex flex-col justify-start items-start font-inter gap-[24px]">
            <h1 className="text-[18px] font-medium tracking-tight">R E S O U R C E S</h1>
            <ul className="space-y-[19px] opacity-60 text-[16px]">
              <li>Free eBooks</li>
